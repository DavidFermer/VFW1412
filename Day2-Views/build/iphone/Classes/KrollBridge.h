...
@interface Day2_ViewsObject : KrollCoverageObject {
#else
@interface Day2_ViewsObject : KrollObject {
#endif
@private
...
extern NSString * Day2_Views$ModuleRequireFormat;
