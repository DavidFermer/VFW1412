...
//@interface Day2_ViewsObject : NSObject
//@end

@interface Day2_ViewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Day2_ViewsObject class]])
		{
			for (NSString *key in [[(Day2_ViewsObject*)o modules] allKeys])
			{
