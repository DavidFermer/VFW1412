...
// in simulator we redefine to format for Day2_Views Developer console
...
{\
	NSString * exceptionName = [@"org.day2_views." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.day2_views";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDay2_ViewsNativeItemNone = -1, 
	UIDay2_ViewsNativeItemSpinner = -2,
	UIDay2_ViewsNativeItemProgressBar = -3,
	
	UIDay2_ViewsNativeItemSlider = -4,
	UIDay2_ViewsNativeItemSwitch = -5,
	UIDay2_ViewsNativeItemMultiButton = -6,
	UIDay2_ViewsNativeItemSegmented = -7,
	
	UIDay2_ViewsNativeItemTextView = -8,
	UIDay2_ViewsNativeItemTextField = -9,
	UIDay2_ViewsNativeItemSearchBar = -10,
	
	UIDay2_ViewsNativeItemPicker = -11,
	UIDay2_ViewsNativeItemDatePicker = -12,
	
	UIDay2_ViewsNativeItemInfoLight = -13,
	UIDay2_ViewsNativeItemInfoDark = -14,
	
	UIDay2_ViewsNativeItemDisclosure = -15,
	
	UIDay2_ViewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Day2_Views instances of
