...
/**
 The base class for all Day2_Views modules
 */
...
/**
 Day2_Views Platform calls this method on startup.
 */
-(void)startup;

/**
 Day2_Views Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Day2_Views Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Day2_Views Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Day2_Views Platform calls this method on resume.
 @param sender The sender of the event.
 */
