...
//@interface Fermer_David_Final_ProjectObject : NSObject
//@end

@interface Fermer_David_Final_ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Fermer_David_Final_ProjectObject class]])
		{
			for (NSString *key in [[(Fermer_David_Final_ProjectObject*)o modules] allKeys])
			{
