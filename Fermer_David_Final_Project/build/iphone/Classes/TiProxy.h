...
//Rare exceptions to indicate a bug in the _fermer_david_final_project code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Fermer_David_Final_Project proxies.
 */
