...
@interface Fermer_David_Final_ProjectObject : KrollCoverageObject {
#else
@interface Fermer_David_Final_ProjectObject : KrollObject {
#endif
@private
...
extern NSString * Fermer_David_Final_Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Fermer_David_Final_ProjectObject *_fermer_david_final_project;
    KrollObject* console;
	BOOL shutdown;
