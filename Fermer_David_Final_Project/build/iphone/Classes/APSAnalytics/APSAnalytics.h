 ...
 * to send analytic data that can be viewed on the Fermer_David_Final_Project Dashboard.
 *
 * For information on getting started with Fermer_David_Final_Project Platform Services,
