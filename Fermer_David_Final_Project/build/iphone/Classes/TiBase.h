...
// in simulator we redefine to format for Fermer_David_Final_Project Developer console
...
{\
	NSString * exceptionName = [@"org.fermer_david_final_project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fermer_david_final_project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFermer_David_Final_ProjectNativeItemNone = -1, 
	UIFermer_David_Final_ProjectNativeItemSpinner = -2,
	UIFermer_David_Final_ProjectNativeItemProgressBar = -3,
	
	UIFermer_David_Final_ProjectNativeItemSlider = -4,
	UIFermer_David_Final_ProjectNativeItemSwitch = -5,
	UIFermer_David_Final_ProjectNativeItemMultiButton = -6,
	UIFermer_David_Final_ProjectNativeItemSegmented = -7,
	
	UIFermer_David_Final_ProjectNativeItemTextView = -8,
	UIFermer_David_Final_ProjectNativeItemTextField = -9,
	UIFermer_David_Final_ProjectNativeItemSearchBar = -10,
	
	UIFermer_David_Final_ProjectNativeItemPicker = -11,
	UIFermer_David_Final_ProjectNativeItemDatePicker = -12,
	
	UIFermer_David_Final_ProjectNativeItemInfoLight = -13,
	UIFermer_David_Final_ProjectNativeItemInfoDark = -14,
	
	UIFermer_David_Final_ProjectNativeItemDisclosure = -15,
	
	UIFermer_David_Final_ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Fermer_David_Final_Project instances of
