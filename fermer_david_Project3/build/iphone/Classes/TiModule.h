...
/**
 The base class for all fermer_david_Project3 modules
 */
...
/**
 fermer_david_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 fermer_david_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 fermer_david_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 fermer_david_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 fermer_david_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
