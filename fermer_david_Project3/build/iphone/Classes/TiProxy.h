...
//Rare exceptions to indicate a bug in the _fermer_david_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for fermer_david_Project3 proxies.
 */
