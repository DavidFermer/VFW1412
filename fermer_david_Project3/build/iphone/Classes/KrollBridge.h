...
@interface fermer_david_Project3Object : KrollCoverageObject {
#else
@interface fermer_david_Project3Object : KrollObject {
#endif
@private
...
extern NSString * fermer_david_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	fermer_david_Project3Object *_fermer_david_project3;
    KrollObject* console;
	BOOL shutdown;
