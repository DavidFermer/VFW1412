 ...
 * to send analytic data that can be viewed on the fermer_david_Project3 Dashboard.
 *
 * For information on getting started with fermer_david_Project3 Platform Services,
