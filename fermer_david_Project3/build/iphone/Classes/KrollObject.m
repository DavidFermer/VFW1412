...
//@interface fermer_david_Project3Object : NSObject
//@end

@interface fermer_david_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[fermer_david_Project3Object class]])
		{
			for (NSString *key in [[(fermer_david_Project3Object*)o modules] allKeys])
			{
