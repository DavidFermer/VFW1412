...
// in simulator we redefine to format for fermer_david_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.fermer_david_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fermer_david_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIfermer_david_Project3NativeItemNone = -1, 
	UIfermer_david_Project3NativeItemSpinner = -2,
	UIfermer_david_Project3NativeItemProgressBar = -3,
	
	UIfermer_david_Project3NativeItemSlider = -4,
	UIfermer_david_Project3NativeItemSwitch = -5,
	UIfermer_david_Project3NativeItemMultiButton = -6,
	UIfermer_david_Project3NativeItemSegmented = -7,
	
	UIfermer_david_Project3NativeItemTextView = -8,
	UIfermer_david_Project3NativeItemTextField = -9,
	UIfermer_david_Project3NativeItemSearchBar = -10,
	
	UIfermer_david_Project3NativeItemPicker = -11,
	UIfermer_david_Project3NativeItemDatePicker = -12,
	
	UIfermer_david_Project3NativeItemInfoLight = -13,
	UIfermer_david_Project3NativeItemInfoDark = -14,
	
	UIfermer_david_Project3NativeItemDisclosure = -15,
	
	UIfermer_david_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all fermer_david_Project3 instances of
