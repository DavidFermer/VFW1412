...
//Rare exceptions to indicate a bug in the _day2_windows code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Day2_Windows proxies.
 */
