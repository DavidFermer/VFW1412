...
/**
 Base class for all Day2_Windows views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Day2_Windows view hierarchy (such as wrapped iOS UIViews) was touched.
