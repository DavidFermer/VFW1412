...
// in simulator we redefine to format for Day2_Windows Developer console
...
{\
	NSString * exceptionName = [@"org.day2_windows." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.day2_windows";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDay2_WindowsNativeItemNone = -1, 
	UIDay2_WindowsNativeItemSpinner = -2,
	UIDay2_WindowsNativeItemProgressBar = -3,
	
	UIDay2_WindowsNativeItemSlider = -4,
	UIDay2_WindowsNativeItemSwitch = -5,
	UIDay2_WindowsNativeItemMultiButton = -6,
	UIDay2_WindowsNativeItemSegmented = -7,
	
	UIDay2_WindowsNativeItemTextView = -8,
	UIDay2_WindowsNativeItemTextField = -9,
	UIDay2_WindowsNativeItemSearchBar = -10,
	
	UIDay2_WindowsNativeItemPicker = -11,
	UIDay2_WindowsNativeItemDatePicker = -12,
	
	UIDay2_WindowsNativeItemInfoLight = -13,
	UIDay2_WindowsNativeItemInfoDark = -14,
	
	UIDay2_WindowsNativeItemDisclosure = -15,
	
	UIDay2_WindowsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Day2_Windows instances of
