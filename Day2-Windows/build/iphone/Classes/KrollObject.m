...
//@interface Day2_WindowsObject : NSObject
//@end

@interface Day2_WindowsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Day2_WindowsObject class]])
		{
			for (NSString *key in [[(Day2_WindowsObject*)o modules] allKeys])
			{
