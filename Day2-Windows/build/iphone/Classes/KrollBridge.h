...
@interface Day2_WindowsObject : KrollCoverageObject {
#else
@interface Day2_WindowsObject : KrollObject {
#endif
@private
...
extern NSString * Day2_Windows$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Day2_WindowsObject *_day2_windows;
    KrollObject* console;
	BOOL shutdown;
