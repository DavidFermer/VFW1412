...
@interface Fermer_David_Project2Object : KrollCoverageObject {
#else
@interface Fermer_David_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Fermer_David_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Fermer_David_Project2Object *_fermer_david_project2;
    KrollObject* console;
	BOOL shutdown;
