...
//@interface Fermer_David_Project2Object : NSObject
//@end

@interface Fermer_David_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Fermer_David_Project2Object class]])
		{
			for (NSString *key in [[(Fermer_David_Project2Object*)o modules] allKeys])
			{
