...
// in simulator we redefine to format for Fermer_David_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.fermer_david_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fermer_david_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFermer_David_Project2NativeItemNone = -1, 
	UIFermer_David_Project2NativeItemSpinner = -2,
	UIFermer_David_Project2NativeItemProgressBar = -3,
	
	UIFermer_David_Project2NativeItemSlider = -4,
	UIFermer_David_Project2NativeItemSwitch = -5,
	UIFermer_David_Project2NativeItemMultiButton = -6,
	UIFermer_David_Project2NativeItemSegmented = -7,
	
	UIFermer_David_Project2NativeItemTextView = -8,
	UIFermer_David_Project2NativeItemTextField = -9,
	UIFermer_David_Project2NativeItemSearchBar = -10,
	
	UIFermer_David_Project2NativeItemPicker = -11,
	UIFermer_David_Project2NativeItemDatePicker = -12,
	
	UIFermer_David_Project2NativeItemInfoLight = -13,
	UIFermer_David_Project2NativeItemInfoDark = -14,
	
	UIFermer_David_Project2NativeItemDisclosure = -15,
	
	UIFermer_David_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Fermer_David_Project2 instances of
