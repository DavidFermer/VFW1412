...
/**
 Base class for all Fermer_David_Project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Fermer_David_Project2 view hierarchy (such as wrapped iOS UIViews) was touched.
