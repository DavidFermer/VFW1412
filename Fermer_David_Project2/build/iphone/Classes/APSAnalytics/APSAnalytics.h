 ...
 * to send analytic data that can be viewed on the Fermer_David_Project2 Dashboard.
 *
 * For information on getting started with Fermer_David_Project2 Platform Services,
