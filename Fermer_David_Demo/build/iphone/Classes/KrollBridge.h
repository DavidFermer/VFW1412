...
@interface Fermer_David_DemoObject : KrollCoverageObject {
#else
@interface Fermer_David_DemoObject : KrollObject {
#endif
@private
...
extern NSString * Fermer_David_Demo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Fermer_David_DemoObject *_fermer_david_demo;
    KrollObject* console;
	BOOL shutdown;
