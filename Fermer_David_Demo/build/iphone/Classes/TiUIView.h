...
/**
 Base class for all Fermer_David_Demo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Fermer_David_Demo view hierarchy (such as wrapped iOS UIViews) was touched.
