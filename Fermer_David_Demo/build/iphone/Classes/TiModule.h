...
/**
 The base class for all Fermer_David_Demo modules
 */
...
/**
 Fermer_David_Demo Platform calls this method on startup.
 */
-(void)startup;

/**
 Fermer_David_Demo Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Fermer_David_Demo Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Fermer_David_Demo Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Fermer_David_Demo Platform calls this method on resume.
 @param sender The sender of the event.
 */
