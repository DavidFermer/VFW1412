...
//Rare exceptions to indicate a bug in the _fermer_david_demo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Fermer_David_Demo proxies.
 */
