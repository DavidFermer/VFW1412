...
//@interface Fermer_David_DemoObject : NSObject
//@end

@interface Fermer_David_DemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Fermer_David_DemoObject class]])
		{
			for (NSString *key in [[(Fermer_David_DemoObject*)o modules] allKeys])
			{
