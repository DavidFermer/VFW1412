...
// in simulator we redefine to format for Fermer_David_Demo Developer console
...
{\
	NSString * exceptionName = [@"org.fermer_david_demo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fermer_david_demo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFermer_David_DemoNativeItemNone = -1, 
	UIFermer_David_DemoNativeItemSpinner = -2,
	UIFermer_David_DemoNativeItemProgressBar = -3,
	
	UIFermer_David_DemoNativeItemSlider = -4,
	UIFermer_David_DemoNativeItemSwitch = -5,
	UIFermer_David_DemoNativeItemMultiButton = -6,
	UIFermer_David_DemoNativeItemSegmented = -7,
	
	UIFermer_David_DemoNativeItemTextView = -8,
	UIFermer_David_DemoNativeItemTextField = -9,
	UIFermer_David_DemoNativeItemSearchBar = -10,
	
	UIFermer_David_DemoNativeItemPicker = -11,
	UIFermer_David_DemoNativeItemDatePicker = -12,
	
	UIFermer_David_DemoNativeItemInfoLight = -13,
	UIFermer_David_DemoNativeItemInfoDark = -14,
	
	UIFermer_David_DemoNativeItemDisclosure = -15,
	
	UIFermer_David_DemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Fermer_David_Demo instances of
